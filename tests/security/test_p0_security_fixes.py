...
class TestPathTraversalPrevention:
    ...
    def test_sanitize_source_name_basic(self):
        ...
        from somdialc.infra.security import sanitize_source_name
...
class TestSecretsMasking:
    ...
    def test_mask_secret_basic(self):
        ...
        from somdialc.infra.security import mask_secret
...
class TestFilenameeSanitization:
    ...
    def test_sanitize_filename_basic(self):
        ...
        from somdialc.infra.security import sanitize_filename
