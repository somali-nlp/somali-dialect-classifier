-- Initial PostgreSQL schema for Somali NLP Ledger
...
-- Grant permissions
GRANT ALL PRIVILEGES ON ALL TABLES IN SCHEMA public TO somali;
GRANT ALL PRIVILEGES ON ALL SEQUENCES IN SCHEMA public TO somali;
