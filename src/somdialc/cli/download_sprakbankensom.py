...
Usage:
    ...
    python -m somdialc.cli.download_sprakbankensom --corpus all

    # Download specific corpus
    python -m somdialc.cli.download_sprakbankensom --corpus somali-ogaden

    # List available corpora
    python -m somdialc.cli.download_sprakbankensom --list

    # Show info about specific corpus
    python -m somdialc.cli.download_sprakbankensom --info somali-cilmi

    # Force reprocessing
    python -m somdialc.cli.download_sprakbankensom --corpus all --force
"""
...
def list_corpora():
    ...
    print("  python -m somdialc.cli.download_sprakbankensom --corpus all")
    print()
    print("To download specific corpus:")
    print("  python -m somdialc.cli.download_sprakbankensom --corpus <corpus_id>")
    print()
