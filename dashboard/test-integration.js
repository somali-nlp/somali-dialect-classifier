...
function loadRealMetricsData() {
    ...
    for (const file of files) {
        ...
        const metric = {
            ...
            http_request_success_rate: data.legacy_metrics?.statistics?.http_request_success_rate ||
                                       data.legacy_metrics?.statistics?.file_extraction_success_rate,
            legacy_metrics: data.legacy_metrics
        };
